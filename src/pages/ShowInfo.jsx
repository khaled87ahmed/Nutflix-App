...
export default function ShowInfo() {
  ...
  const isFavorite = favorites.some((fav) => fav.id === movieInfo?.id);

  const handleFavoriteClick = () => {
    if (isFavorite) {
      dispatch(removeFavorite(movieInfo?.id)); // Use the correct ID property from your movieInfo object
    } else {
      dispatch(addFavorite(movieInfo)); // Pass the movieInfo object
    }
  };
  return (
    <>
          ...
          <div id="movie-info" className=" d-flex gap-5">
            ...
            <div className="mt-5">
              ...
              <div className="d-flex gap-2">
                ...
                <button
                  onClick={handleFavoriteClick} // Call the handleFavoriteClick function
                  style={{
                    background: isFavorite ? "#FFA07A" : "#00CE79",
                    border: "none",
                    color: "black",
                    fontSize: 18,
                    fontWeight: 500,
